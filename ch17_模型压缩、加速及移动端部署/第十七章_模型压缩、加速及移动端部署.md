...
![](/assets/ch17/tensorRT1.png)

![](/assets/ch17/tensorRT2.png)

![](/assets/ch17/tensorRT3.png)
...
传统卷积计算方式如下：  
![image](/assets/ch17/3.png)
传统卷积运算量为：  
$$
A = H * W * h1 * w1 * c1 * c2
$$
DW卷积的计算方式如下：  
![image](/assets/ch17/4.png)
DW卷积运算量为：
$$
B_DW = H * W * h1 * w1 * 1 * c1
$$
PW卷积的计算方式如下：
![image](/assets/ch17/5.png)
...
![image](/assets/ch17/6.png)
实验中使用的基本网络结构，分别将它们重复10次，然后进行实验。实验结果如下：
![image](/assets/ch17/7.png)
...
![image](/assets/ch17/9.png)
SqueezeNet整体网络结构如下图所示：
![image](/assets/ch17/10.png)

#### 1.3实验结果
不同压缩方法在ImageNet上的对比实验结果
![image](/assets/ch17/11.png)
...
* DW conv和PW conv
  ...
  ![image](/assets/ch17/12.png)
  深度可分离卷积与传统卷积运算量对比：
  ![image](/assets/ch17/13.png)
  网络结构：
  ![image](/assets/ch17/14.png)

* MobileNets的架构
  ![image](/assets/ch17/15.png)

#### 2.3 实验结果
![image](/assets/ch17/16.png)
...
*  Inverted residuals  
   ...
   ![image](/assets/ch17/17.png)
*  Linear bottlenecks  
   ReLu激活函数会破坏特征。ReLu对于负的输入，输出全为0，而本来DW conv特征通道已经被“压缩”，再经过ReLu的话，又会损失一部分特征。采用Linear，目的是防止Relu破坏特征。
   ![image](/assets/ch17/18.png)
* shortcut  
  stride=2的conv不使用shot-cot，stride=1的conv使用shot-cut
  ![image](/assets/ch17/19.png)
* 网络架构  
  ![image](/assets/ch17/20.png)
...
![image](/assets/ch17/26.png)
网络结构  
![image](/assets/ch17/27.png)
...
![](/assets/ch17/mace-work-flow-zh.png)
...
![](/assets/ch17/framework_design.png)
...
![](/assets/ch17/packflow2.jpg)

![](/assets/ch17/packflow3.jpg)
...
![](/assets/ch17/packflow4.jpg)

![](/assets/ch17/packflow5.jpg)
