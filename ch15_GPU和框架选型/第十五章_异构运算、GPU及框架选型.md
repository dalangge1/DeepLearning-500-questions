...
![CPU和GPU的简单架构对比图](/assets/ch15/cpu_gpu.png)
...
![CPU简单信息](/assets/ch15/cpu_specs.png)

![GPU的简单信息对比](/assets/ch15/gpu_specs.png)
...
![GPU的简单信息对比](/assets/ch15/gpu_memory_arch.png)

![GPU的内存架构容量信息](/assets/ch15/gpu_memory.png)
...
![CUDA简单介绍](/assets/ch15/cudacore.jpg)
...
![CUDA 矩阵乘法示例](/assets/ch15/mat_mul_gpu.png)
...
![浮点计算能力和价格的对比。](/assets/ch15/gtx.png)
...
上文中有关于cuda的介绍，这里只是简单介绍基于Linux系统安装cuda的具体步骤，可以根据自己的需要安装cuda8.0或者cuda9.0，这两种版本的安装步骤基本一致，这里以最常用的ubuntu 16.04 lts版本为例：  
   1. 官网下载，地址  
    ...
    ![cuda8.0](/assets/ch15/cuda8.0.png)

    ![cuda9.0](/assets/ch15/cuda9.0.png)  
